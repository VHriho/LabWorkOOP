...
public class ImmutableMatrix implements IMatrix{
    ...
    public IMatrix upperTriangular() {
        ...
        ImmutableMatrix upperMatrix = new ImmutableMatrix(this.getRows(), this.getColumns());
    ...
    public IMatrix lowerTriangular() {
        ...
        ImmutableMatrix lowerMatrix = new ImmutableMatrix(this.getRows(), this.getColumns());
